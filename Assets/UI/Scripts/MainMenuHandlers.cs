...
{	
	...
	private void Play()
	{
        _disSetting = FindObjectOfType<DiscoSetting>();
        SceneManager.LoadScene("PlayScene");
        _disSetting.DiscoTime();
	}
	...
	public void SetAudioVolume()
	{
        ...
        AudioListener.volume = AudioSlider.value;// Set the volume for the audio under the PlayerPrefs key 'AudioVolume'.
	}
